...
/**
 * This is the item provider adapter for a {@link metamodeloEnorm.Action} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ActionItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						MetamodeloEnormPackage.Literals.ACTION__NAME, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Action_returnType_feature",
								"_UI_Action_type"),
						MetamodeloEnormPackage.Literals.ACTION__RETURN_TYPE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addBodyPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						MetamodeloEnormPackage.Literals.ACTION__BODY, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MetamodeloEnormPackage.Literals.ACTION__ACTS_ON_ACTUATOR);
			childrenFeatures.add(MetamodeloEnormPackage.Literals.ACTION__MAY_SEND_NOTIFICATION);
			childrenFeatures.add(MetamodeloEnormPackage.Literals.ACTION__HAS_ATTRIBUTES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(MetamodeloEnormPackage.Literals.ACTION__ACTS_ON_ACTUATOR,
				MetamodeloEnormFactory.eINSTANCE.createActuator()));

		newChildDescriptors.add(createChildParameter(MetamodeloEnormPackage.Literals.ACTION__MAY_SEND_NOTIFICATION,
				MetamodeloEnormFactory.eINSTANCE.createNotification()));

		newChildDescriptors.add(createChildParameter(MetamodeloEnormPackage.Literals.ACTION__HAS_ATTRIBUTES,
