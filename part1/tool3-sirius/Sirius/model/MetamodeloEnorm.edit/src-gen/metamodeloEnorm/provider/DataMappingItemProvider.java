...
/**
 * This is the item provider adapter for a {@link metamodeloEnorm.DataMapping} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DataMappingItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_DataMapping_name_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_DataMapping_name_feature",
								"_UI_DataMapping_type"),
						MetamodeloEnormPackage.Literals.DATA_MAPPING__NAME, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MetamodeloEnormPackage.Literals.DATA_MAPPING__STORES_DATAIN_DATA_CORE);
		}
	...
	public String getText(Object object) {
		String label = ((DataMapping) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_DataMapping_type")
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors
				.add(createChildParameter(MetamodeloEnormPackage.Literals.DATA_MAPPING__STORES_DATAIN_DATA_CORE,
