...
/**
 * This is the item provider adapter for a {@link metamodeloEnorm.Scenario} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ScenarioItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Scenario_name_feature",
								"_UI_Scenario_type"),
						MetamodeloEnormPackage.Literals.SCENARIO__NAME, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MetamodeloEnormPackage.Literals.SCENARIO__HAS_ACTUATOR);
			childrenFeatures.add(MetamodeloEnormPackage.Literals.SCENARIO__HAS_ATTRIBUTES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(MetamodeloEnormPackage.Literals.SCENARIO__HAS_ACTUATOR,
				MetamodeloEnormFactory.eINSTANCE.createActuator()));

		newChildDescriptors.add(createChildParameter(MetamodeloEnormPackage.Literals.SCENARIO__HAS_ATTRIBUTES,
