...
/**
 * This is the item provider adapter for a {@link metamodeloEnorm.Sensor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SensorItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						MetamodeloEnormPackage.Literals.SENSOR__NAME, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MetamodeloEnormPackage.Literals.SENSOR__MAPS_THROUGH_DATA_MAPPING);
			childrenFeatures.add(MetamodeloEnormPackage.Literals.SENSOR__HAS_ATTRIBUTE);
			childrenFeatures.add(MetamodeloEnormPackage.Literals.SENSOR__FOLLOWS_CONDITIONS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(MetamodeloEnormPackage.Literals.SENSOR__MAPS_THROUGH_DATA_MAPPING,
				MetamodeloEnormFactory.eINSTANCE.createDataMapping()));

		newChildDescriptors.add(createChildParameter(MetamodeloEnormPackage.Literals.SENSOR__HAS_ATTRIBUTE,
				MetamodeloEnormFactory.eINSTANCE.createAttribute()));

		newChildDescriptors.add(createChildParameter(MetamodeloEnormPackage.Literals.SENSOR__FOLLOWS_CONDITIONS,
