...
public class Generate extends AbstractAcceleoGenerator {
    ...
    public void registerPackages(ResourceSet resourceSet) {
        ...
        if (!isInWorkspace(metamodeloEnorm.MetamodeloEnormPackage.class)) {
            resourceSet.getPackageRegistry().put(metamodeloEnorm.MetamodeloEnormPackage.eINSTANCE.getNsURI(), metamodeloEnorm.MetamodeloEnormPackage.eINSTANCE);
        }
